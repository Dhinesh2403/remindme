...
@Component({
  ...
  styles: [`
    ...
    .feature-row { background:white; border-radius:16px; padding:16px; display:flex; gap:14px; align-items:flex-start; box-shadow:var(--rm-shadow-sm); }
    ...
    .plan { background:white; border-radius:20px; padding:20px 16px; text-align:center; border:2px solid var(--rm-border); box-shadow:var(--rm-shadow-sm); position:relative; }
    ...
    .btn-upgrade { width:100%; padding:12px; background:white; color:var(--rm-purple); border:2px solid var(--rm-purple); border-radius:12px; font-size:13px; font-weight:700; cursor:pointer; font-family:inherit; margin-top:8px; }
